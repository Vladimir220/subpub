...
const (
	PubSub_Subscribe_FullMethodName = "/subpub_service.PubSub/Subscribe"
	PubSub_Publish_FullMethodName   = "/subpub_service.PubSub/Publish"
)
...
var PubSub_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "subpub_service.PubSub",
